...
class ApplicationController < ActionController::Base
  ...
  def filters
    payload = {
      fuels: ['Газ', 'Газ / Бензин', 'Газ пропан-бутан', 'Бензин', 'Гибрид', 'Дизель', 'Другое', 'Электро'],
      wheels: ['Передний', 'Задний', 'Полный', 'Кардан', 'Цепь'],
      carcasses: ['Хэтчбек', 'Купе', 'Универсал', 'Седан', 'Пикап', 'Внедорожник / Кроссовер', 'Лифтбек', 'Кабриолет', 'Родстер', 'Легковой фургон (до 1,5 т)', 'Минивэн', 'Другой'],
